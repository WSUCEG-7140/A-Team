...
class Server:
    ...
    def update_order_information(self, order_id):
        ...
        result = self.orders.update_order_amount(order_id, updated_amount)  # Updates order information in the database
        if result is True:
    ...
    def setup_routes(self):
        ...
        self.app.route('/updateOrderInformation/<int:order_id>', methods=['POST'])(
            self.update_order_information) # Sets up a route to remove order from the database
